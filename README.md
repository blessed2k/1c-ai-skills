...
| Команда | Что делает |
|---|---|
| `/1c-dev:bsl-standards` | Правила стандартов 1С (ИТС), на которых агент ошибается или которые появились недавно: исключения, транзакции, пакетная запись регистров, файлы, длительные операции, клиент-сервер, запросы, HTTPS и права, обработчики записи |
